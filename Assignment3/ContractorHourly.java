...
public class ContractorHourly extends Person{
	...
	ContractorHourly(String firstName, String lastName){
		super(firstName, lastName);
	}
	ContractorHourly(String firstName, String lastName, int age, int SSN, String id, 
